GOLDENRODGAMECORNER_TM25_COINS EQU 1500 ;5500
GOLDENRODGAMECORNER_TM14_COINS EQU 1500
GOLDENRODGAMECORNER_TM38_COINS EQU 1500
...
.loop
	...
	verticalmenu
	closewindow
	ifequal 1, .Abra	; gives abra
	ifequal 2, .Cubone	; porygon
	ifequal 3, .Wobbuffet	; dratini
	sjump GoldenrodGameCornerPrizeVendor_CancelPurchaseScript
