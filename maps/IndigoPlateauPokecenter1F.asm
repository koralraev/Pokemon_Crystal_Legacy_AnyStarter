...
IndigoPlateauPokecenter1F_MapEvents:
	...
	object_event  6,  9, SPRITE_FLYSERVICE_ABRA, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Indigo_FlyService, EVENT_FLYSERVICE_HIDE_ABRA
