...
BugsyGroup:
	...
	db 53, FORRETRESS,  BERRY_JUICE,  CURSE, EXPLOSION, PIN_MISSILE, SPIKE_CANNON
	db 53, SHUCKLE,     SMOOTH_ROCK,  TOXIC, PROTECT, SANDSTORM, WRAP
...
PryceGroup:
	...
	db 31, DEWGONG,    NO_ITEM,     SURF, AURORA_BEAM, HAIL, REST
	...
	db 33, JYNX,      NO_ITEM,      ICE_PUNCH, PSYCHIC_M, HAIL, LOVELY_KISS
	...
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 37, CLOYSTER,    ICY_ROCK,    SURF, SPIKES, AURORA_BEAM, HAIL
	...
	db 55, PILOSWINE,   SOFT_SAND,      HAIL, EARTHQUAKE, ROCK_SMASH, BLIZZARD
	db -1 ; end
...
JasmineGroup:
	...
	db 53, CORSOLA,    NO_ITEM,       SANDSTORM, SURF, RECOVER, ANCIENTPOWER
...
KarenGroup:
	...
	db 55, HOUNDOOM,    BLACKGLASSES,   FLAMETHROWER, CRUNCH, IRON_TAIL, NASTY_PLOT
	db -1 ; end
...
; KAREN (2) Rematch
	db "KAREN@", TRAINERTYPE_DVS | TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
		db 68, UMBREON
			...
			dw $01FE, $01FE, $01FE, $01FE, $01FE ; hp, atk, def, spd, spc
			db MIRACLEBERRY
            db NASTY_PLOT, SHADOW_BALL, HIDDEN_POWER, BATON_PASS
        db 67, GENGAR
			db $dc, $dd
			dw $80BE, $80BE, $80BE, $80BE, $80BE ; hp, atk, def, spd, spc
			db SCOPE_LENS
...
KogaGroup:
	...
	db 51, VENOMOTH,    BIG_ROOT,        LEECH_LIFE, PSYCHIC_M, SLUDGE_BOMB, SLEEP_POWDER
...
BlaineGroup:
	...
	db 66, RAPIDASH,   HEAT_ROCK,      DOUBLE_EDGE, SUNNY_DAY, FIRE_BLAST, SOLARBEAM
...
ExecutiveMGroup:	
	...
	db 38, TAUROS,      DOUBLE_EDGE, HEADBUTT, ROCK_SMASH, PURSUIT
	...
	db 29, TAUROS,      RAGE, DOUBLE_EDGE, HORN_ATTACK, PURSUIT
...
RedGroup:
	...
	db 77, VENUSAUR,   BIG_ROOT,       GIGA_DRAIN, BODY_SLAM, SLEEP_POWDER, LEECH_SEED
