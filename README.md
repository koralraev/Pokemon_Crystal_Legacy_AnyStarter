...
This started as a fork of Crystal Legacy (https://github.com/cRz-Shadows/Pokemon_Crystal_Legacy) but grew to be more than a few simple addition. 
...
+ Give unlimited haircuts to quickly and easily increase your pokemons happiness
+ An in-battle menu for tracking battle stat changes, screen and weathers turns can be openend by pressing START
...
+ Several existing moves have been changed to make them more viable and fun to use, eg. Flash is now an electric type priroity move with a change to flinch the target
...
+ Goldenrod City main street is no longer blocked by NPCs walking about
